...
// 	err := svcClient.Delete(context.TODO(), ArgoUIServiceName, &metav1.DeleteOptions{})
// 	if err != nil {
...
// 	for _, bindingName := range []string{KubeTaskerControllerClusterRole, ArgoUIClusterRoleBinding} {
...
// 	for _, roleName := range []string{KubeTaskerControllerClusterRole, ArgoUIClusterRole} {
...
// 	for _, serviceAccount := range []string{KubeTaskerControllerServiceAccount, ArgoUIServiceAccount} {
